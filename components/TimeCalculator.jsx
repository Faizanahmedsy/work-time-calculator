    ...
    <SkeletonMountain>
      <div className="flex flex-col h-screen justify-center items-center relative z-10 leading-5 tracking-wider gap-10">
        ...
        <div className="flex flex-col gap-6 w-full max-w-2xl">
          ...
          >
            <DialogContent className="bg-black/30 backdrop-blur-md border border-white/10 text-white rounded-3xl">
              <DialogHeader>
                  ...
                  <div className="flex gap-3 items-center">
                    <div className="flex flex-col">
                      ...
                      <Input
                        ...
                        className="w-20 bg-black/50 border-white/20"
                      />
                    </div>
              ...
              <DialogFooter>
                <Button
                  ...
                  className="text-gray-300 border-white/20 hover:bg-white/10 rounded-full"
                >
                  Reset to Defaults
                </Button>
                <Button
                  onClick={() => setShowSettings(false)}
                  className="bg-pink-500/20 hover:bg-pink-500/30 text-pink-200 border border-pink-500/30 rounded-full"
                >
                  Save Settings
                </Button>
              </DialogFooter>
